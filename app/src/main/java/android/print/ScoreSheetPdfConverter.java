...
public class ScoreSheetPdfConverter {
    ...
    public void convert(ScoreSheetBuilder.ScoreSheet scoreSheet) {
        ...
        WebSettings _ws = mWebView.getSettings();
        _ws.setJavaScriptEnabled(false);
        _ws.setAllowFileAccess(false);
        _ws.setAllowContentAccess(false);
        _ws.setAllowUniversalAccessFromFileURLs(false);
        _ws.setBuiltInZoomControls(false);
        _ws.setDisplayZoomControls(false);
_ws.setJavaScriptEnabled(false);
_ws.setAllowFileAccess(false);
_ws.setAllowContentAccess(false);
_ws.setAllowUniversalAccessFromFileURLs(false);
