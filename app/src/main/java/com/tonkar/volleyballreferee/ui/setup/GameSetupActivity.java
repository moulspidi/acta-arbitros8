...
public class GameSetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditCurrent = getIntent().getBooleanExtra("edit_current", false);
        mGame = mEditCurrent ? storedGamesService.loadCurrentGame() : storedGamesService.loadSetupGame();
    ...
    public void computeStartGameButton() {
        ...
        if (mEditCurrent) {
            saveButton.setText(R.string.apply_and_return);
            saveButton.setIconResource(R.drawable.ic_check);
            saveButton.setOnClickListener(this::applyChangesAndReturn);
        } else if (cannotStartGame(mGame)) {
